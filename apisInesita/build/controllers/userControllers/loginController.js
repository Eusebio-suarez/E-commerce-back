...
const loginModel_1 = require("../../models/userModels/loginModel");
...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const token = jsonwebtoken_1.default.sign({ id: usuario.id_usuario, nombre: usuario.nombre_usuario, correo: usuario.correo, rol: usuario.rol }, SECRET_KEY, {
            expiresIn: "1h"
        });
