...
exports.crearUsuario = exports.validarCorreo = void 0;
const db_1 = __importDefault(require("./db"));
const validarCorreo = (correo) => __awaiter(void 0, void 0, void 0, function* () {
    const [rows] = yield db_1.default.query("SELECT * FROM usuarios WHERE correo = ?", [correo]);
    return rows.length > 0;
});
exports.validarCorreo = validarCorreo;
const crearUsuario = (nombre, correo, contraseña) => __awaiter(void 0, void 0, void 0, function* () {
